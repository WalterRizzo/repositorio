...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-[#10121a] border-r border-gray-800 p-4 space-y-4 text-white sticky top-16 self-start h-[calc(100vh-4rem)] overflow-auto z-40">
